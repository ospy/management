...
/**
 * Servlet implementation class CheckSelfMobile
 */
@WebServlet("/CheckSelfMobile")

public class CheckSelfMobile extends HttpServlet {
		...
		String result = null;
			...
			try {
				 Connection conn = DBPool.getInstance().getConnection(); 
					String sql1 = "{call CheckSelfMobile(?,?)}";
				CallableStatement call1= conn.prepareCall(sql1);
				call1.setString(1,mobile);
