    ...
    <ul class="am-list admin-sidebar-list">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
          <li><a target="blank" href="/User/usermanage.jsp" class="am-cf"><span class="am-icon-check"></span>用户列表<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>

        </ul>
      </li>
      <li><a target="blank" href="/ResManage/reslist.jsp"><span class="am-icon-table"></span>资源管理</a></li>
      <li><a target="blank" href="/Account/acclist.jsp"><span class="am-icon-pencil-square-o"></span>账户管理</a></li>
      <li><a href="#"><span class="am-icon-sign-out"></span>使用统计</a></li>
    </ul>
