...
var _44=$.data(e.data.target,"_draggable");
var _45=_44.options;
...
var _4a=$.data(e.data.target,"_draggable");
_39(e);
...
_49(e);
var _4f=$.data(e.data.target,"_draggable");
var _50=_4f.proxy;
var _51=_4f.options;
...
$.fn._draggable=function(_57,_58){
if(typeof _57=="string"){
return $.fn._draggable.methods[_57](this,_58);
}
return this.each(function(){
var _59;
var _5a=$.data(this,"_draggable");
if(_5a){
_5a.handle.unbind("._draggable");
_59=$.extend(_5a.options,_57);
}else{
_59=$.extend({},$.fn._draggable.defaults,$.fn._draggable.parseOptions(this),_57||{});
}
var _5b=_59.handle?(typeof _59.handle=="string"?$(_59.handle,this):_59.handle):$(this);
$.data(this,"_draggable",{options:_59,handle:_5b});
if(_59.disabled){
$(this).css("cursor","");
return;
}
_5b.unbind("._draggable").bind("mousemove._draggable",{target:this},function(e){
if($.fn._draggable.isDragging){
return;
}
var _5c=$.data(e.data.target,"_draggable").options;
if(_5d(e)){
...
$.extend(e.data,_60);
var _61=$.data(e.data.target,"_draggable").options;
if(_61.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown._draggable",e.data,_43);
$(document).bind("mousemove._draggable",e.data,_49);
$(document).bind("mouseup._draggable",e.data,_4d);
...
function _5d(e){
var _62=$.data(e.data.target,"_draggable");
var _63=_62.handle;
var _64=$(_63).offset();
...
$.fn._draggable.parseOptions=function(_67){
var t=$(_67);
...
function _76(e){
var _77=e.data;
var _78=$.data(_77.target,"_resizable").options;
...
function _80(e){
var _81=$(e.data.target)._resizable("options");
...
$.fn._resizable=function(_88,_89){
if(typeof _88=="string"){
return $.fn._resizable.methods[_88](this,_89);
}
return this.each(function(){
var _8a=null;
var _8b=$.data(this,"_resizable");
if(_8b){
$(this).unbind("._resizable");
_8a=$.extend(_8b.options,_88||{});
}else{
_8a=$.extend({},$.fn._resizable.defaults,$.fn._resizable.parseOptions(this),_88||{});
$.data(this,"_resizable",{options:_8a});
}
...
$(document).bind("mousedown._resizable",_8d,_7d);
$(document).bind("mousemove._resizable",_8d,_7e);
$(document).bind("mouseup._resizable",_8d,_7f);
...
$.fn._resizable.parseOptions=function(_8e){
var t=$(_8e);
...
_f2.disabledNodes=[];
_f3.dnd=true;
_f4.find("div.tree-node")._draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_f5){
...
var icon=$(_106)._draggable("proxy").find("span.tree-dnd-icon");
...
_29e.window._draggable({handle:">div.panel-header>div.panel-title",disabled:_29e.options._draggable==false,onBeforeDrag:function(e){
if(_29e.mask){
...
_29e.window._resizable({disabled:_29e.options._resizable==false,onStartResize:function(e){
_29f(e);
},onResize:function(e){
_2a0(e);
return false;
...
return $.extend({},$.fn.panel.parseOptions(_2ac),$.parser.parseOptions(_2ac,[{_draggable:"boolean",_resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,_draggable:true,_resizable:true,shadow:true,modal:false,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
function _2ad(_2ae){
...
$.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"Ok",cancel:"Cancel",width:300,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,_resizable:false,fn:function(){
}});
})(jQuery);
(function($){
...
_3d1._resizable($.extend({},{handles:(_3d0[dir]||""),disabled:(!pp.panel("options").split),onStartResize:function(e){
_3b9=true;
...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["id","field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",_resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
...
_6e0.each(function(){
$(this)._resizable({handles:_6e1,edge:opts.resizeEdge,disabled:($(this).attr("_resizable")?$(this).attr("_resizable")=="false":false),minWidth:25,onStartResize:function(e){
_6dc.resizing=true;
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{groupHeight:28,expanderWidth:20,singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:20,_resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,_resizable:false}]],showGroup:false,groupView:_8ed,groupField:"group",groupStyler:function(_942,rows){
return "";
...
_c3f.find("a.slider-handle")._draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
